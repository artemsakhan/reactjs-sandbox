...
const GiftBonusesInfo = ({openPopup}) => {
    return (
        <div style={{
            ...
            <div style={{
                position: 'absolute', // @TODO AVOID USING ABS POSITION, MAKE PROPER CENTERING
                right: '15px',
                top: '25px',
            }}>
...
const CloseButton = ({handleClose}) => {
    return (
        ...
        >
            <CloseShape fillColor={'#000'} width={35} height={35} strokeWidth={1}/>
        </motion.div>
    )
}
