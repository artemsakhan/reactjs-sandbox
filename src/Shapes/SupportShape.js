const SupportShape = ({width, height, fillColor, styles}) => {
    return (
        <svg fill={fillColor} width={width} height={height} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={styles}>
            <path
