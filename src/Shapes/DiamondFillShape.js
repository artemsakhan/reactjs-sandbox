const DiamondFillShape = ({width, height, fillColor, style}) => {
    return (
        <svg fill={fillColor} width={width} height={height} viewBox="0 0 32 32" version="1.1" style={style}
...
export default DiamondFillShape;