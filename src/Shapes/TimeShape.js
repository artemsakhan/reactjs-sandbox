const TimeShape = ({fillColor = '#000000', width = 25, height = 25, styles}) => {
    return (
        <svg fill={fillColor} width={width} height={height} style={styles} viewBox="0 0 24 24"
