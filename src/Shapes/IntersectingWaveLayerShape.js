const IntersectingWaveLayerShape = ({fillColor, width, height, style}) => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1000 100' fill={fillColor} width={width} height={height}
             style={style}>
...
export default IntersectingWaveLayerShape;